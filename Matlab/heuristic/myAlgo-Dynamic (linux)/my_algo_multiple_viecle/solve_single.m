function [served_node,start_time,infeas_nodes,current_time,load,waiting]=solve_single(served_node_all,served_node_v,infeas_nodes_v,start_time_mat_v,current_time_v,load_vec_v,cap,speed,Max_ride,x_coord,y_coord,d_vec,q_vec,e_vec,l_vec,alpha)
...
%%%% from here
     ...
     [travelling_time,nearest_nodes,infeas_nodes,not_good_neghbor]=closest(x_coord,y_coord,e_vec,l_vec,Max_ride,served_node_coord,served_node_all,current_time,speed,d_vec,infeas_list,alpha);
